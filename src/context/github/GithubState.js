...
const GithubState = props => {
  ...
  const searchUsers = async text => {
    setLoading();
    const res = await axios.get(`https://api.github.com/search/users?q=${text}&client_id=${githubClinetId}&client_secret=${githubClientSecret}`);
    dispatch({
      type: SEARCH_USERS,
